...
viewManager.addRoute("/test/login", () => loginRegisterView);
...
var loginRegisterView = (() => {
    function loginRegisterView() {
        ...
        this.getHtml = () => $.ajax({url: "http://localhost:5555/static/Views/LoginRegisterView/LoginRegisterView.html",contentType: "text"});
